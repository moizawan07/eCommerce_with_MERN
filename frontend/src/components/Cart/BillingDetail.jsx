...
const BillingDetails = ({ modaal, cardProucts, orderState }) => {
  ...
  return (
    <div className="w-full fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-3 md:p-6 border border-gray-300 rounded-md shadow-md md:w-130 z-50 animate-fade-in">
      <button className="absolute top-2 right-2 text-gray-500 hover:text-gray-700 focus:outline-none">
        <AiOutlineClose
          className="h-6 w-6"
          onClick={() => console.log(modaal(false))}
        />
      </button>
      ...
      <div className="mt-4">
        ...
        <div className="flex items-center mb-1">
          ...
          />
          <label htmlFor="easypaisa" className="text-gray-700 text-sm">
            Easypaisa
          </label>
        </div>
        <div className="flex items-center mb-1">
          <input
            ...
            className="mr-2 focus:ring-red-500 h-4 w-4 text-red-600 border-gray-300"
          />
          <label htmlFor="cashOnDelivery" className="text-gray-700 text-sm">
            Cash on Delivery
          </label>
        </div>
      </div>
      ...
      <div className="mt-4 flex items-center">
        <input
          ...
          id="saveInfo"
          name="saveInfo"
          className="mr-2 focus:ring-red-500 h-4 w-4 text-red-600 border-gray-300 rounded"
        />
      ...
      <button
        onClick={placeOrder}
        className="bg-red-500 hover:bg-red-700 text-white font-bold py-3 px-6 rounded mt-6 focus:outline-none focus:shadow-outline"
      >
        Place Order
      </button>
